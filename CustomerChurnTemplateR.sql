/* 
	Description: This file execute the following procedure to create features, train an open source R model and make predictions for the customer churn template.
